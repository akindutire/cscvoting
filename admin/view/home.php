...
<body>
	...
	<div class="w3-row" style="background: url(../images/content/home_bg.jpg);">
		...
		<div class="w3-container w3-half w3-center w3-white w3-card-4 w3-animate-left" style="height: auto; margin-left: 24%; margin-right: 24%; margin-top: 5%; margin-bottom: 10%; padding: 0px;">
			...
			<form class="w3-form" method="post" action=<?php echo $config['control']['login']; ?> style="padding:5%;">
				...
				<p><button id="btnlogin" class="w3-btn w3-indigo w3-center">Enter</button></p>
